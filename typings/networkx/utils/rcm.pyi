...
def cuthill_mckee_ordering(G, heuristic=...): # -> Generator[Unknown, None, None]:
...
def reverse_cuthill_mckee_ordering(G, heuristic=...): # -> reversed[Unknown]:
    """Generate an ordering (permutation) of the graph nodes to make
    a sparse matrix.
...
def connected_cuthill_mckee_ordering(G, heuristic=...): # -> Generator[Unknown, None, None]:
    ...
