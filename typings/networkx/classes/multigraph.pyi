...
class MultiGraph(Graph):
    ...
    **Subclasses (Advanced):**
    ...
    def add_edges_from(self, ebunch_to_add, **attr): # -> list[Unknown]:
    ...
    def has_edge(self, u, v, key=...): # -> bool:
    ...
    def get_edge_data(self, u, v, key=..., default=...): # -> None:
    ...
    def copy(self, as_view=...): # -> Self@MultiGraph:
    ...
    def to_directed(self, as_view=...): # -> MultiDiGraph:
    ...
    def to_undirected(self, as_view=...): # -> MultiGraph:
    ...
    def number_of_edges(self, u=..., v=...): # -> int | float:
