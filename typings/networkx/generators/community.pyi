...
@py_random_state(3)
def random_partition_graph(sizes, p_in, p_out, seed=..., directed=...):
...
@py_random_state(4)
def planted_partition_graph(l, k, p_in, p_out, seed=..., directed=...):
...
@py_random_state(6)
def gaussian_random_partition_graph(n, s, v, p_in, p_out, directed=..., seed=...):
...
def ring_of_cliques(num_cliques, clique_size): # -> Graph:
...
@py_random_state(3)
def stochastic_block_model(sizes, p, nodelist=..., seed=..., directed=..., selfloops=..., sparse=...): # -> DiGraph | Graph:
...
@py_random_state(11)
def LFR_benchmark_graph(n, tau1, tau2, mu, average_degree=..., min_degree=..., max_degree=..., min_community=..., max_community=..., tol=..., max_iters=..., seed=...): # -> Graph:
