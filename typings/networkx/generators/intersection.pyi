...
@py_random_state(3)
def uniform_random_intersection_graph(n, m, p, seed=...): # -> MultiDiGraph | DiGraph | MultiGraph | Graph:
...
@py_random_state(3)
def k_random_intersection_graph(n, m, k, seed=...): # -> MultiDiGraph | DiGraph | MultiGraph | Graph:
...
@py_random_state(3)
def general_random_intersection_graph(n, m, p, seed=...): # -> MultiDiGraph | DiGraph | MultiGraph | Graph:
