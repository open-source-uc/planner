...
@py_random_state(3)
def gn_graph(n, kernel=..., create_using=..., seed=...):
...
@py_random_state(3)
def gnr_graph(n, p, create_using=..., seed=...):
...
@py_random_state(2)
def gnc_graph(n, create_using=..., seed=...):
...
@py_random_state(7)
def scale_free_graph(n, alpha=..., beta=..., gamma=..., delta_in=..., delta_out=..., create_using=..., seed=..., initial_graph=...): # -> MultiDiGraph:
...
@py_random_state(4)
def random_uniform_k_out_graph(n, k, self_loops=..., with_replacement=..., seed=...):
...
@py_random_state(4)
def random_k_out_graph(n, k, alpha, self_loops=..., seed=...):
