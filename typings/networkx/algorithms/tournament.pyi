...
def index_satisfying(iterable, condition): # -> int:
...
@not_implemented_for("undirected")
@not_implemented_for("multigraph")
def hamiltonian_path(G): # -> list[Unknown]:
...
@py_random_state(1)
def random_tournament(n, seed=...): # -> DiGraph:
...
@not_implemented_for("undirected")
@not_implemented_for("multigraph")
def score_sequence(G): # -> list[Unknown]:
