...
def node_attribute_xy(G, attribute, nodes=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def node_degree_xy(G, x=..., y=..., weight=..., nodes=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
