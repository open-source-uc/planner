...
def degree_assortativity_coefficient(G, x=..., y=..., weight=..., nodes=...):
...
def degree_pearson_correlation_coefficient(G, x=..., y=..., weight=..., nodes=...):
    """Compute degree assortativity of graph.
...
def attribute_assortativity_coefficient(G, attribute, nodes=...):
...
def numeric_assortativity_coefficient(G, attribute, nodes=...):
