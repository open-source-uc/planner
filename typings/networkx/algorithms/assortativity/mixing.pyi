...
"""
__all__ = ["attribute_mixing_matrix", "attribute_mixing_dict", "degree_mixing_matrix", "degree_mixing_dict", "numeric_mixing_matrix", "mixing_dict"]
def attribute_mixing_dict(G, attribute, nodes=..., normalized=...): # -> dict[Unknown, Unknown]:
...
def attribute_mixing_matrix(G, attribute, nodes=..., mapping=..., normalized=...):
...
def degree_mixing_dict(G, x=..., y=..., weight=..., nodes=..., normalized=...): # -> dict[Unknown, Unknown]:
...
def degree_mixing_matrix(G, x=..., y=..., weight=..., nodes=..., normalized=..., mapping=...):
    """Returns mixing matrix for attribute.
...
def numeric_mixing_matrix(G, attribute, nodes=..., normalized=..., mapping=...):
...
def mixing_dict(xy, normalized=...): # -> dict[Unknown, Unknown]:
