...
def triangles(G, nodes=...): # -> dict[Unknown, Unknown]:
...
def average_clustering(G, nodes=..., weight=..., count_zeros=...): # -> float:
...
def clustering(G, nodes=..., weight=...): # -> int | dict[Unknown, Unknown | int]:
...
def transitivity(G): # -> float | Literal[0]:
...
def square_clustering(G, nodes=...): # -> dict[Unknown, Unknown]:
...
@not_implemented_for("directed")
def generalized_degree(G, nodes=...): # -> dict[Unknown, Unknown]:
