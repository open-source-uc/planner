...
def could_be_isomorphic(G1, G2): # -> bool:
...
def fast_could_be_isomorphic(G1, G2): # -> bool:
    """Returns False if graphs are definitely not isomorphic.
...
def faster_could_be_isomorphic(G1, G2): # -> bool:
    """Returns False if graphs are definitely not isomorphic.
...
def is_isomorphic(G1, G2, node_match=..., edge_match=...): # -> bool:
