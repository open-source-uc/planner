...
@not_implemented_for("directed")
def biconnected_component_edges(G): # -> Generator[Unknown, None, None]:
...
@not_implemented_for("directed")
def biconnected_components(G): # -> Generator[set[Unknown], None, None]:
...
@not_implemented_for("directed")
def articulation_points(G): # -> Generator[Unknown, None, None]:
