...
class _DataEssentialsAndFunctions:
    def __init__(self, G, multigraph, demand=..., capacity=..., weight=...) -> None:
        ...
    
    def initialize_spanning_tree(self, n, faux_inf): # -> None:
        ...
    
    def find_apex(self, p, q): # -> int | None:
        """
        Find the lowest common ancestor of nodes p and q in the spanning tree.
        """
        ...
    
    def trace_path(self, p, w): # -> tuple[list[Unknown], list[Unknown]]:
        """
        Returns the nodes and edges on the path from node p to its ancestor w.
        """
        ...
    
    def find_cycle(self, i, p, q): # -> tuple[list[Unknown], list[Unknown]]:
        """
    ...
    def trace_subtree(self, p): # -> Generator[Unknown | int, None, None]:
        """
    ...
    def find_entering_edges(self): # -> Generator[tuple[int, Unknown, Unknown], None, None]:
        """Yield entering edges until none can be found."""
        ...
    
    def residual_capacity(self, i, p): # -> int:
        """Returns the residual capacity of an edge i in the direction away
        from its endpoint p.
        """
        ...
    
    def find_leaving_edge(self, Wn, We): # -> tuple[Unknown, Unknown, Unknown]:
...
def network_simplex(G, demand=..., capacity=..., weight=...): # -> tuple[int | Unknown, dict[Unknown, dict[Unknown, Unknown]]]:
