...
def preflow_push_impl(G, s, t, capacity, residual, global_relabel_freq, value_only): # -> DiGraph:
    """Implementation of the highest-label preflow-push algorithm."""
    ...

def preflow_push(G, s, t, capacity=..., residual=..., global_relabel_freq=..., value_only=...): # -> DiGraph:
