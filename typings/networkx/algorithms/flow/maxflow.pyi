...
def maximum_flow(flowG, _s, _t, capacity=..., flow_func=..., **kwargs): # -> tuple[Unknown, dict[Unknown, Unknown]]:
...
def maximum_flow_value(flowG, _s, _t, capacity=..., flow_func=..., **kwargs):
...
def minimum_cut(flowG, _s, _t, capacity=..., flow_func=..., **kwargs): # -> tuple[Unknown, tuple[set[Unknown], set[Unknown]]]:
...
def minimum_cut_value(flowG, _s, _t, capacity=..., flow_func=..., **kwargs):
