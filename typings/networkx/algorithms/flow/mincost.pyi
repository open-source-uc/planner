...
def min_cost_flow_cost(G, demand=..., capacity=..., weight=...):
...
def min_cost_flow(G, demand=..., capacity=..., weight=...):
...
def cost_of_flow(G, flowDict, weight=...): # -> int:
...
def max_flow_min_cost(G, s, t, capacity=..., weight=...):
