...
def katz_centrality(G, alpha=..., beta=..., max_iter=..., tol=..., nstart=..., normalized=..., weight=...): # -> dict[Unknown, int]:
...
@not_implemented_for("multigraph")
def katz_centrality_numpy(G, alpha=..., beta=..., normalized=..., weight=...): # -> dict[Any, Any]:
