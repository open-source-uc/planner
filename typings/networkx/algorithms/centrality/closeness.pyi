...
def closeness_centrality(G, u=..., distance=..., wf_improved=...): # -> dict[Unknown, Unknown]:
...
def incremental_closeness_centrality(G, edge, prev_cc=..., insertion=..., wf_improved=...): # -> dict[Unknown, Unknown]:
