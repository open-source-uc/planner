...
def betweenness_centrality_subset(G, sources, targets, normalized=..., weight=...): # -> dict[Unknown, float]:
...
def edge_betweenness_centrality_subset(G, sources, targets, normalized=..., weight=...): # -> dict[Unknown, float]:
...
def betweenness_centrality_source(G, normalized=..., weight=..., sources=...): # -> dict[Unknown, float]:
    ...
