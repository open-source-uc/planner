...
def subgraph_centrality_exp(G): # -> dict[Any, Any]:
...
@not_implemented_for("directed")
@not_implemented_for("multigraph")
def subgraph_centrality(G): # -> dict[Any, Any]:
...
@not_implemented_for("directed")
@not_implemented_for("multigraph")
def communicability_betweenness_centrality(G): # -> dict[Unknown, Unknown]:
