...
def trophic_levels(G, weight=...): # -> dict[Unknown, Unknown]:
...
@not_implemented_for("undirected")
def trophic_differences(G, weight=...): # -> dict[Unknown, Unknown]:
...
@not_implemented_for("undirected")
def trophic_incoherence_parameter(G, weight=..., cannibalism=...):
