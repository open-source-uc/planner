...
def is_k_edge_connected(G, k): # -> bool:
...
@not_implemented_for("directed")
@not_implemented_for("multigraph")
def is_locally_k_edge_connected(G, s, t, k): # -> bool:
...
@not_implemented_for("directed")
@not_implemented_for("multigraph")
def k_edge_augmentation(G, k, avail=..., weight=..., partial=...): # -> Generator[Unknown | tuple[Unknown, Unknown], None, None]:
...
def partial_k_edge_augmentation(G, k, avail, weight=...): # -> Generator[Unknown, None, None]:
...
@not_implemented_for("multigraph")
@not_implemented_for("directed")
def one_edge_augmentation(G, avail=..., weight=..., partial=...): # -> Generator[tuple[Unknown, Unknown], None, None] | Generator[Unknown, None, None]:
...
@not_implemented_for("multigraph")
@not_implemented_for("directed")
def bridge_augmentation(G, avail=..., weight=...): # -> Generator[tuple[Unknown, Unknown], None, None] | Generator[Unknown, None, None]:
...
MetaEdge = ...
def unconstrained_one_edge_augmentation(G): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def weighted_one_edge_augmentation(G, avail, weight=..., partial=...): # -> Generator[Unknown, None, None]:
...
def unconstrained_bridge_augmentation(G): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def weighted_bridge_augmentation(G, avail, weight=...): # -> Generator[Unknown, None, None]:
...
def complement_edges(G): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
@not_implemented_for("multigraph")
@not_implemented_for("directed")
def greedy_k_edge_augmentation(G, k, avail=..., weight=..., seed=...): # -> Generator[Unknown, None, None]:
