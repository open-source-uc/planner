...
def k_edge_components(G, k): # -> Generator[Unknown, None, None]:
...
@not_implemented_for("multigraph")
def k_edge_subgraphs(G, k): # -> Generator[set[Unknown], None, None]:
...
@not_implemented_for("multigraph")
def bridge_components(G): # -> Generator[Unknown, None, None]:
...
class EdgeComponentAuxGraph:
    ...
    """
    @classmethod
    def construct(EdgeComponentAuxGraph, G): # -> Self@EdgeComponentAuxGraph:
    ...
    def k_edge_components(self, k): # -> Generator[Unknown, None, None]:
    ...
    def k_edge_subgraphs(self, k): # -> Generator[set[Unknown] | Unknown, None, None]:
...
def general_k_edge_subgraphs(G, k): # -> Generator[Unknown, None, None]:
