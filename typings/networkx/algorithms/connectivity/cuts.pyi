...
def minimum_st_edge_cut(G, s, t, flow_func=..., auxiliary=..., residual=...): # -> set[Unknown]:
...
def minimum_st_node_cut(G, s, t, flow_func=..., auxiliary=..., residual=...): # -> set[Unknown] | dict[Unknown, Unknown]:
...
def minimum_node_cut(G, s=..., t=..., flow_func=...): # -> set[Unknown] | dict[Unknown, Unknown]:
...
def minimum_edge_cut(G, s=..., t=..., flow_func=...): # -> set[Unknown]:
