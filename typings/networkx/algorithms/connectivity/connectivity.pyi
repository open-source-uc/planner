...
def local_node_connectivity(G, s, t, flow_func=..., auxiliary=..., residual=..., cutoff=...):
...
def node_connectivity(G, s=..., t=..., flow_func=...): # -> Literal[0]:
...
def average_node_connectivity(G, flow_func=...): # -> float | Literal[0]:
...
def all_pairs_node_connectivity(G, nbunch=..., flow_func=...): # -> dict[Unknown, dict[Unknown, Unknown]]:
...
def local_edge_connectivity(G, s, t, flow_func=..., auxiliary=..., residual=..., cutoff=...):
...
def edge_connectivity(G, s=..., t=..., flow_func=..., cutoff=...): # -> Literal[0]:
