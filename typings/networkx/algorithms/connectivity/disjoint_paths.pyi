...
def edge_disjoint_paths(G, s, t, flow_func=..., cutoff=..., auxiliary=..., residual=...): # -> Generator[list[Unknown], None, None]:
...
def node_disjoint_paths(G, s, t, flow_func=..., cutoff=..., auxiliary=..., residual=...): # -> Generator[list[object], None, None]:
