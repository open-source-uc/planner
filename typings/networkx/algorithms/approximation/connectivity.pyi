...
def local_node_connectivity(G, source, target, cutoff=...): # -> int:
...
def node_connectivity(G, s=..., t=...): # -> int:
...
def all_pairs_node_connectivity(G, nbunch=..., cutoff=...): # -> dict[Unknown, dict[Unknown, Unknown]]:
