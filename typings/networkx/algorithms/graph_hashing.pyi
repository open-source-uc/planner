...
def weisfeiler_lehman_graph_hash(G, edge_attr=..., node_attr=..., iterations=..., digest_size=...): # -> str:
...
def weisfeiler_lehman_subgraph_hashes(G, edge_attr=..., node_attr=..., iterations=..., digest_size=...): # -> dict[Unknown, list[Unknown]]:
    """
