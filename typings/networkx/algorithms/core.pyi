...
"""
__all__ = ["core_number", "find_cores", "k_core", "k_shell", "k_crust", "k_corona", "k_truss", "onion_layers"]
@not_implemented_for("multigraph")
def core_number(G): # -> dict[Unknown, Unknown]:
...
@not_implemented_for("multigraph")
@not_implemented_for("directed")
def onion_layers(G): # -> dict[Unknown, Unknown]:
