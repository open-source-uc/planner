...
def mutual_weight(G, u, v, weight=...): # -> int:
...
def normalized_mutual_weight(G, u, v, norm=..., weight=...): # -> float | Literal[0]:
...
def effective_size(G, nodes=..., weight=...): # -> dict[Unknown, Unknown]:
...
def constraint(G, nodes=..., weight=...): # -> dict[Unknown, Unknown]:
...
def local_constraint(G, u, v, weight=...): # -> float | int:
