...
def normalized_cut_size(G, S, T=..., weight=...): # -> float:
...
def conductance(G, S, T=..., weight=...): # -> float:
...
def edge_expansion(G, S, T=..., weight=...): # -> float:
...
def mixing_expansion(G, S, T=..., weight=...):
...
def boundary_expansion(G, S): # -> float:
