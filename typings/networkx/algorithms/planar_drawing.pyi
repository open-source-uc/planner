...
def combinatorial_embedding_to_pos(embedding, fully_triangulate=...): # -> dict[Unknown, Unknown]:
...
def set_position(parent, tree, remaining_nodes, delta_x, y_coordinate, pos): # -> None:
    """Helper method to calculate the absolute position of nodes."""
    ...

def get_canonical_ordering(embedding, outer_face): # -> list[None]:
...
def triangulate_face(embedding, v1, v2): # -> None:
...
def triangulate_embedding(embedding, fully_triangulate=...): # -> tuple[Unknown, list[Unknown]] | tuple[PlanarEmbedding, list[Unknown | tuple[Unknown, Unknown | None]]]:
...
def make_bi_connected(embedding, starting_node, outgoing_node, edges_counted): # -> list[Unknown]:
