...
__all__ = ["bfs_edges", "bfs_tree", "bfs_predecessors", "bfs_successors", "descendants_at_distance", "bfs_layers"]
def generic_bfs_edges(G, source, neighbors=..., depth_limit=..., sort_neighbors=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def bfs_edges(G, source, reverse=..., depth_limit=..., sort_neighbors=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def bfs_tree(G, source, reverse=..., depth_limit=..., sort_neighbors=...): # -> DiGraph:
...
def bfs_predecessors(G, source, depth_limit=..., sort_neighbors=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def bfs_successors(G, source, depth_limit=..., sort_neighbors=...): # -> Generator[tuple[Unknown, list[Unknown]], None, None]:
...
def bfs_layers(G, sources): # -> Generator[list[Unknown], None, None]:
...
def descendants_at_distance(G, source, distance): # -> set[Unknown]:
