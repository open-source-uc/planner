...
def dfs_edges(G, source=..., depth_limit=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def dfs_tree(G, source=..., depth_limit=...): # -> DiGraph:
...
def dfs_predecessors(G, source=..., depth_limit=...): # -> dict[Unknown, Unknown]:
...
def dfs_successors(G, source=..., depth_limit=...): # -> dict[Unknown, list[Unknown]]:
...
def dfs_postorder_nodes(G, source=..., depth_limit=...): # -> Generator[Unknown, None, None]:
...
def dfs_preorder_nodes(G, source=..., depth_limit=...): # -> Generator[Unknown, None, None]:
...
def dfs_labeled_edges(G, source=..., depth_limit=...): # -> Generator[tuple[Unknown, Unknown, Literal['forward']] | tuple[Unknown, Unknown, Literal['nontree']] | tuple[Unknown, Unknown, Literal['reverse']], None, None]:
