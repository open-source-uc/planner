...
def color(G): # -> dict[Unknown, Unknown]:
...
def is_bipartite_node_set(G, nodes): # -> bool:
...
def sets(G, top_nodes=...): # -> tuple[set[Unknown], set[Unknown]]:
...
def degrees(B, nodes, weight=...): # -> tuple[Unknown, Unknown]:
