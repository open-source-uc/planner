...
__all__ = ["project", "projected_graph", "weighted_projected_graph", "collaboration_weighted_projected_graph", "overlap_weighted_projected_graph", "generic_weighted_projected_graph"]
def projected_graph(B, nodes, multigraph=...): # -> MultiDiGraph | DiGraph | MultiGraph | Graph:
...
def weighted_projected_graph(B, nodes, ratio=...): # -> DiGraph | Graph:
...
@not_implemented_for("multigraph")
def collaboration_weighted_projected_graph(B, nodes): # -> DiGraph | Graph:
...
@not_implemented_for("multigraph")
def overlap_weighted_projected_graph(B, nodes, jaccard=...): # -> DiGraph | Graph:
...
@not_implemented_for("multigraph")
def generic_weighted_projected_graph(B, nodes, weight_function=...): # -> DiGraph | Graph:
...
def project(B, nodes, create_using=...): # -> MultiDiGraph | DiGraph | MultiGraph | Graph:
    ...
