...
def to_nested_tuple(T, root, canonical_form=...): # -> tuple[()] | tuple[Unknown, ...]:
...
def from_nested_tuple(sequence, sensible_relabeling=...): # -> Any:
...
@not_implemented_for("directed")
def to_prufer_sequence(T): # -> list[Unknown]:
