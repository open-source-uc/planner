  ...
  return (
        <div className="flex py-2 px-4  border text-yellow-700 border-yellow-300 bg-yellow-50 font-semibold">
          <p>
            ...
            Le informamos que el Nuevo Planner no estará disponible el INSERTAR_FECHA entre las INSERTAR_HORA_INICIO y las INSERTAR_HORA_FIN hrs debido a una mantención programada en nuestros servidores. Agradecemos su comprensión.</p>
        </div>
  )
}
