  ...
  return (
      <div className="flex py-2 px-4  border text-yellow-700 border-yellow-300 bg-yellow-50 font-semibold">
        <p>
          ...
          Estás en una visualización exclusiva para moderadores. Puedes ver e interactuar con los planes del estudiante, pero no puedes guardar los cambios realizados.</p>
      </div>
  )
}
