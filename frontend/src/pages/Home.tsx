    ...
    <div className='bg-gradient-to-b from-blue-500 h-full'>
      <div className="max-w-3xl mx-auto mt-8 prose center">
          ...
          {authState?.user != null
            ...
            : (<div className='flex justify-evenly'><a href="/api/auth/login"><button className='rounded-lg py-2 px-4 bg-blue-800 text-white'>Iniciar sesión</button></a><Link to="/planner"><button className='rounded-lg py-2 px-4 bg-blue-800 text-white'>Continuar como invitado</button></Link></div>)}
          {/* <pre>
